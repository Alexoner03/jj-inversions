...
Confirme el acceso a su cuenta ingresando el código de autenticación proporcionado por su aplicación de autenticación.            </template>

            <template v-else>

Confirme el acceso a su cuenta ingresando uno de sus códigos de recuperación de emergencia.            </template>
        </div>
        ...
        <form @submit.prevent="submit">
            ...
            <div v-else>
                <jet-label for="recovery_code" value="Codigo de recuperación" />
...
Usa un código de recuperación                    </template>
